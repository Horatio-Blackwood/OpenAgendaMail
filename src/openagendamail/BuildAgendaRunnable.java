...
public class BuildAgendaRunnable implements Runnable {
    ...
    private static void generatePdfAgenda(){
        try {
            ...
            pdf.renderLine(sub, PdfFont.HELVETICA, 9);
            ...
            if (!items.isEmpty()){
                ...
                for (AgendaItem item : items){
                    ...
                    pdf.renderLine(fromLine, PdfFont.HELVETICA, 9);
                ...
                pdf.renderLine("No items were submitted to the agenda.", PdfFont.HELVETICA, 12);
            }
            try {
                // Save PDF to disk.
